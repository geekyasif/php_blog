    ...
    <div class="form" id="form">
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF'] ); ?>" method="post">
            <div class="form-group contact-form-group">
                <input type="text" class="form-control contact-form-control bg-light" id="exampleInputEmail1" aria-describedby="emailHelp"
                    placeholder="NAME" name="name" required>
            </div>
            <div class="form-group contact-form-group">
                <input type="email" class="form-control contact-form-control bg-light" id="exampleInputEmail1" placeholder="EMAIL" name="email" required>
            </div>
            <div class="form-group contact-form-group">
                <textarea class="form-control contact-form-control bg-light" id="exampleFormControlTextarea1" rows="3"
