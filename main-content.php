<div class="col-md-8 border bg-white mb-5">
    ...
    <div class="col-md-12 mt-3">
        <div class="latest-post">
            <h3 id="post-heading">Latest Post</h3>
            <hr id="post-heading-hr" width="25%" class="float-md-left">
            <br>
        </div>
    </div>
    <?php 
    ...
    <div class="col-md-12 ">
        <div class="post-content mb-4">
            <div class="row">
                <div class="col-md-4">
                    <a class="post-img" href="post_content.php?post_title=<?php echo $row['post_title']; ?>"><img
                            src="admin/upload/<?php echo $row['post_image']; ?>" alt="" / width="200" height="160"></a>
                </div>
                    ...
                    <div class="inner-content ">
                        ...
                        <div class="post-information">
                            ...
                            <span>
                                ...
                                <a href='author.php?author_name=<?php echo $row['post_author']; ?>'><?php echo $row['post_author']; ?></a>
                            </span>
                            <span>
